    ...
    if call.message:
        if call.data == '⬅️ Назад':
            ...
            bot.edit_message_text(chat_id=call.message.chat.id,
                                  message_id=call.message.message_id, text="Выберите подкатегорию")
            bot.edit_message_reply_markup(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                          inline_message_id=call.inline_message_id, reply_markup=menu.ret)
            ...
            bot.edit_message_text(chat_id=call.message.chat.id,
                                  message_id=call.message.message_id, text="Выберите подкатегорию")
            bot.edit_message_reply_markup(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                          inline_message_id=call.inline_message_id, reply_markup=menu.tovar)
        elif call.data == 'Авито':
            bot.edit_message_text(chat_id=call.message.chat.id,
                                  message_id=call.message.message_id, text="Выберите подкатегорию")
            bot.edit_message_reply_markup(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                          inline_message_id=call.inline_message_id, reply_markup=menu.rend)
...
def send_otziv(message):
    if message.text == '💌 Отзывы':
        ...
        url_button = types.InlineKeyboardButton(
            text="Оставить первый отзыв", url="https://t.me/g5u675fvm")
        ...
        keyboard = types.InlineKeyboardMarkup()
        url_button = types.InlineKeyboardButton(
            text="Присоединиться", url="https://t.me/joinchat/AAAAAFj0WHiR5Eq-5KHWTg")
        keyboard.add(url_button)
        bot.send_message(
            message.chat.id, "❗️Наш новостной канал - https://t.me/joinchat/AAAAAFj0WHiR5Eq-5KHWTg", reply_markup=keyboard)
        ...
        print('Нажал Работа. ID: '+str(message.chat.id) +
              '    Дата/время: '+str(datetime.now()))
